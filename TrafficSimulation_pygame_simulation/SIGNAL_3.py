...
from subscribe_3 import mqttLoop, mqttMessage
import subscribe_3
import os
...
def repeat():
    ...
    while (signals[currentGreen].green > 0):  # while the timer of current green signal is not zero
        updateValues()
        ################################################################################
        if subscribe_3.stopSignal :
            time.sleep(15)
            subscribe_3.stopSignal = False
        ################################################################################
        time.sleep(1)
...
class Main:
    ...
    pygame.display.set_caption("SIGNAL 3")
    ...
    while True:
        ...
        for i in range(0, noOfSignals):  # display signal and set timer according to current status: green, yello, or red
            ...
            if count == 0:
                ...
                client.publish('signal3/relay1', signals[i].green)
